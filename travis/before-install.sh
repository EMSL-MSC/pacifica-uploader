...
docker run -it --rm --net=pacificauploader_default -e METADATA_URL=http://metadataserver:8121 -v $PWD/test_files:/usr/src/app/test_files -e PYTHONPATH=/usr/src/app pacifica/metadata python test_files/loadit.py
